...
class MealPlanningService:
    ...
    async def _generate_recipes_with_images_parallel(
        ...
        import asyncio
        from services.ai_service import ChefoodAIService
    ...
    async def _generate_single_recipe_fast(self, meal_info: Dict, ai_service) -> Dict:
        ...
        try:
            from schemas.ai_schemas import AIRequest, AIRequestType, AIModelType
            ...
            ai_request = AIRequest(
                ...
                preferences=meal_info.get('preferences', {}),
                context={
                    'meal_type': meal_info['meal_type'],
                    'target_calories': meal_info.get('target_calories'),
                    'family_size': meal_info['family_size']
                },
            ...
            if response and response.content:
                ...
                return self._parse_recipe_response(response.content, meal_info)
